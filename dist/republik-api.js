...
class RepubliKAPI {
  constructor(opts) {
    ...
    this._getRelations = (userId, followers = false, q = "", lastKey = "", startAt = "") =>
    ...
    this._searchUserByUsername = (username) =>
      __awaiter(this, void 0, void 0, function* () {
        var _d
        let data = []
        try {
    ...
    this._updateProfile = (newValue, type) =>
      __awaiter(this, void 0, void 0, function* () {
        var _e
    ...
    this.Self = {
      getProfile: () =>
        __awaiter(this, void 0, void 0, function* () {
          return yield this.getProfile(this.userId)
        }),
      getVotes: () =>
        __awaiter(this, void 0, void 0, function* () {
          return yield this._getVotes()
        }),
      getFollowers: (opt) =>
        __awaiter(this, void 0, void 0, function* () {
          return yield this.getFollowers(this.userId, opt)
        }),
      getFollowing: (opt) =>
        __awaiter(this, void 0, void 0, function* () {
          return yield this.getFollowing(this.userId, opt)
        }),
      getPosts: (opt) =>
        __awaiter(this, void 0, void 0, function* () {
          return yield this.getPosts(this.userId, opt)
        }),
      getTimeline: (opt) =>
        __awaiter(this, void 0, void 0, function* () {
          var _g
        ...
        __awaiter(this, void 0, void 0, function* () {
          ...
          try {
            const response = yield axios_1.default.post(
              `${constants_1.BASE_API_URL}/production/profile/${userId}/followers`,
              {},
              {
                headers: Object.assign({ Authorization: `Bearer ${this.authToken}` }, this._getHeaders())
              }
      ...
      like: (activityId) =>
        __awaiter(this, void 0, void 0, function* () {
          ...
          try {
            const response = yield axios_1.default.post(
              `${constants_1.BASE_API_URL}/production/activity-likes`,
              { activityId },
              {
                headers: Object.assign({ Authorization: `Bearer ${this.authToken}` }, this._getHeaders())
              }
      ...
      comment: (activityId, commentText, mentions = []) =>
        __awaiter(this, void 0, void 0, function* () {
          var _l
          let data = undefined
          try {
      ...
      updateProfile: {
        name: (newValue) =>
          __awaiter(this, void 0, void 0, function* () {
            return this._updateProfile(newValue, "name")
          }),
        bio: (newValue) =>
          __awaiter(this, void 0, void 0, function* () {
            return this._updateProfile(newValue, "bio")
          }),
        email: (newValue) =>
          __awaiter(this, void 0, void 0, function* () {
            return this._updateProfile(newValue, "email")
          })
      }
    }
    ...
    this.getFollowing = (userId, opt) =>
      __awaiter(this, void 0, void 0, function* () {
        const response = yield this._getRelations(userId, true, opt === null || opt === void 0 ? void 0 : opt.q, opt === null || opt === void 0 ? void 0 : opt.lastKey, opt === null || opt === void 0 ? void 0 : opt.startAt)
        return response
      })
    this.getPosts = (userId, options) =>
      __awaiter(this, void 0, void 0, function* () {
        var _p
        let data = undefined
        let streamToken = undefined
    ...
    this.getPost = (activityId, options) =>
      __awaiter(this, void 0, void 0, function* () {
        var _q
        let data = undefined
        let streamToken = undefined
    ...
    this.refreshAccessToken = () =>
      __awaiter(this, void 0, void 0, function* () {
        var _r, _s, _t
        if (!this.refreshToken) return { error: true, message: "refreshToken not set" }
        try {
          const response = yield axios_1.default.post(
            `${constants_1.SERVICE_PROVIDER_URl}`,
            {
          ...
          if ((_s = (_r = response === null || response === void 0 ? void 0 : response.data) === null || _r === void 0 ? void 0 : _r.AuthenticationResult) === null || _s === void 0 ? void 0 : _s.IdToken) {
            return { newToken: response.data.AuthenticationResult.IdToken }
          }
          return response === null || response === void 0 ? void 0 : response.data
        } catch (err) {
          return (_t = err === null || err === void 0 ? void 0 : err.response) === null || _t === void 0 ? void 0 : _t.data
        }
      })
